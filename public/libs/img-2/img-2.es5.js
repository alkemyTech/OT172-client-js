 ...
 */
const Img2 = (function (_HTMLElement) {
  ...
  function Img2 () {
    ...
    const _this = _possibleConstructorReturn(this, (Img2.__proto__ || Object.getPrototypeOf(Img2)).call(this))
  ...
  _createClass(Img2, [{
    ...
    value: function _preCache (url, cb) {
      const slot = Img2._preCacheCallbacks[url]
      if (slot === undefined) {
        ...
        Img2._worker.postMessage({ location, url })
      } else {
        if (slot.cached === true) {
          cb()
        } else {
